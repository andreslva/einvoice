...
@XmlRootElement(name = "EstadoDeCuentaBancario", namespace = "http://www.sat.gob.mx/ecb")
public class EstadoDeCuentaBancario {

    @XmlElement(name = "Movimientos", namespace = "http://www.sat.gob.mx/ecb", required = true)
    ...
    public static class Movimientos {
        ...
        @XmlElements({
            @XmlElement(name = "MovimientoECB", namespace = "http://www.sat.gob.mx/ecb", type = EstadoDeCuentaBancario.Movimientos.MovimientoECB.class),
            @XmlElement(name = "MovimientoECBFiscal", namespace = "http://www.sat.gob.mx/ecb", type = EstadoDeCuentaBancario.Movimientos.MovimientoECBFiscal.class)
        })
        ...
        public static class MovimientoECBFiscal {
            ...
            /**
             * Obtiene el valor de la propiedad rfCenajenante.
             * 
             * @return
             *     possible object is
             *     {@link String }
